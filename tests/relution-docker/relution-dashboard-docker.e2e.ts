/** Drives the Relution dashboard Docker scenario against an isolated fixture stack. */
...
test("local Docker Relution import/export supports dashboard audit with mock devices", { timeout: 900_000 }, async () => {
  ...
  await runRelutionScenario(360, async () => {
    ...
    await writeVerifiedExportedPolicy(policyUuid, exportedPath, "exported rexp verification");
