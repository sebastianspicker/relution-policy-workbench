/** Validates vendor recommendation sources and their mapping evidence. */
...
test("offline vendor harvester reproduces committed vendor source artifacts", () => {
  ...
  execFileSync("python3", ["-B", "tools/harvest_vendor_guidance.py", "--offline", "--output-root", outputRoot], {
    cwd: resolve("."),
    stdio: "pipe",
  });
