#!/usr/bin/env node
// Extract deterministic Windows CSP evidence from reviewed example Relution archives.
import {
  mkdtempSync,
  writeFileSync,
} from "node:fs";
...
import {
  listDirectoryNames,
  readUtf8File,
} from "./windows-rexp-evidence-files.mjs";
import { parseSyncMl } from "./windows-rexp-evidence-xml.mjs";
